...
import about from '@views/inventory/inventory';
import aboutTemplate from '@views/inventory/inventory.template';
...
export { default as about } from '@views/inventory/inventory';
export { default as aboutTemplate } from '@views/inventory/inventory.template';
